-- Admin Base v2 Schema Draft
-- This draft contains only retained system tables (no FK constraints).
-- Table names are kept compatible with existing MyBatis Plus entity mappings.
-- Phase 1: schema only; no data migration from v1.
